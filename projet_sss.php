	...
	function getTextProjet_sss() {
		...
		<section class="theme1 colonne">
			...
			<section class="theme3 colonne">
				...
				<img src="images/sss/sss03.png" alt="I am an image :D">
				<p>
					Trying transparency ... work a bit, but it\'s too hard to understand.
				</p>
				<img src="images/sss/sss02.png" alt="I am an image :D">
				<p>
					Playing with colors ... work a bit too.
				</p>
				<img src="images/sss/sss08.png" alt="I am an image :D">
				<p>
					Lowering blocks, not working :D
				</p>
				<img src="images/sss/sss11.png" alt="I am an image :D">
				<h3>
			...
			<section class="theme3 colonne">
				...
				<img src="images/sss/sss09.png" alt="I am an image :D">
				<p>
					Let\'s raise up the walls !<br>
					And ... omg where I am ?!?<br>
					I NEED to found the exit =)
				</p>
				<img src="images/sss/sss15.png" alt="I am an image :D">
			</section>
		</section>
		';
