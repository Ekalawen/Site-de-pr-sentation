	...
	function getTextProjet_sss() {
		...
		<section class="theme1 colonne">
			...
			<section class="theme3 colonne">
				...
				<img class="resp_extend" src="images/sss/sss03.jpg" alt="SSS 03">
				<p>
					Trying transparency ... work a bit, but it\'s too hard to understand.
				</p>
				<img class="resp_extend" src="images/sss/sss02.jpg" alt="SSS 02">
				<p>
					Playing with colors ... work a bit too.
				</p>
				<img class="resp_extend" src="images/sss/sss08.jpg" alt="SSS 08">
				<p>
					Lowering blocks, not working :D
				</p>
				<img class="resp_extend" src="images/sss/sss11.jpg" alt="SSS 11">
				<h3>
				...
				<img class="resp_extend" src="images/sss/sss13.jpg" alt="SSS 13">
				<p>
					I understand, and you ? are you sure ? :D
				</p>
				<img class="resp_extend" src="images/sss/sss12.jpg" alt="SSS 12">
			</section>
			<h3 class="mt3">
			...
			<section class="theme3 colonne">
				...
				<img class="resp_extend" src="images/sss/sss09.jpg" alt="SSS 09">
				<p>
					Let\'s raise up the walls !<br>
					And ... omg where I am ?!?<br>
					I NEED to found the exit =)
				</p>
				<img class="resp_extend" src="images/sss/sss15.jpg" alt="SSS 15">
			</section>
		</section>
		';
