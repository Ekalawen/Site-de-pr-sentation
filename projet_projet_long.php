	...
	function getTextProjet_ra() {
		...
		<section class="theme1 colonne">
			...
			<section class="theme2 colonne">
				<img class="resp_extend" src="images/projet_long/projet_long01.jpg" alt="Projet long 01">
				<p>
		...
		<section class="theme2 colonne">
			...
			<section class="theme3 colonne">
				<img class="resp_extend" src="images/projet_long/exemple01.jpg" alt="Exemple 01">
				<p>
					But I never said : "we will place a room here !"
				</p>
				<img class="resp_extend" src="images/projet_long/symbole02.jpg" alt="Symbole 02">
				<p>
			...
			<section class="theme3 colonne">
				<img class="resp_extend" src="images/projet_long/projet_long07.jpg" alt="Projet long 07">
				<p>
				...
				<img class="resp_extend" src="images/projet_long/projet_long09.jpg" alt="Projet long 09">
				<p>
