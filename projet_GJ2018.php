	...
	function getTextProjet_GJ2018() {
		...
		<section class="theme1 colonne">
				...
				<section class="theme2 inlineBlock">
					<img class="size500 resp_extend" src="images/GJ2018/worm.jpg" alt="Worm">
					<img class="size500 resp_extend" src="images/GJ2018/VR_view.jpg" alt="VR view">
					<p>
		...
		<section class="theme1 colonne">
			...
			<section class="theme3 inlineBlock">
				<img class="size500 resp_extend" src="images/GJ2018/map.jpg" alt="Map">
				<p>
		...
		<section class="theme2 colonne">
			...
			<section class="theme3 inlineBlock">
				<img class="size500 resp_extend" src="images/GJ2018/first_screen.jpg" alt="First screen">
				<img class="size500 resp_extend" src="images/GJ2018/second_screen.jpg" alt="Second screen">
				<img class="size500 resp_extend" src="images/GJ2018/third_screen.jpg" alt="Third screen">
				<p>
