	...
	function getTextProjet_PrinceDesVoleurs() {
		...
		<section class="theme1 colonne">
				...
				<section class="theme2 inlineBlock">
					<img class="size40percent" src="images/PrinceDesVoleurs/all.png" alt="I am an image :D">
					<p>
		...
		<section class="theme2 colonne">
			...
			<p class="justifyText">
				...
				<section class="theme3 inlineBlock">
					<img class="size40percent" src="images/PrinceDesVoleurs/explication.png" alt="I am an image :D">
					<p>
		...
		<section class="theme2 colonne">
			...
			<section class="theme3 inlineBlock">
				<img class="size40percent" src="images/PrinceDesVoleurs/guildes.png" alt="I am an image :D">
				<p>
		...
		<section class="theme1 colonne">
			...
			<section class="theme3 inlineBlock">
				<img class="size40percent" src="images/PrinceDesVoleurs/allegence.png" alt="I am an image :D">
				<p>
					An Allegence card
				</p>
			</section>
		...
		<section class="theme2 colonne">
			...
			<section class="theme3 inlineBlock">
				<img class="size40percent" src="images/PrinceDesVoleurs/merveille.png" alt="I am an image :D">
				<p>
					A typical Wonder !
				</p>
			</section>
