		...
		<section class="theme1 colonne">
			...
			<div class="w50 justifyText resp_extend">
				<p class="justifyText">
					...
					For this reason, I naturally became a developer where achieving my dreams has never been easier.<br>
					<br>
					Imagining, visualizing, designing, developing, testing and balancing.<br>
					That\'s how I have already designed and developed numerous board games and video games.<br>
					<br>
