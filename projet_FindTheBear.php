	...
	function getTextProjet_FindTheBear() {
		...
		<section class="theme1 colonne">
				...
				<section class="theme2 colonne">
					<img class="size500 resp_extend" src="images/FindTheBear/oscillations.gif" alt="Oscillations">
					<p>
		...
		<section class="theme2 colonne">
			...
			<section class="theme3 colonne">
				<img class="size500 resp_extend" src="images/FindTheBear/death.jpg" alt="Death">
				<p>
					Oh, you died :\'(<br>
			...
			<section class="theme3 colonne">
				<img class="size500 resp_extend" src="images/FindTheBear/movement_decomposition.jpg" alt="Movement decomposition">
				<p>
			...
			<section class="theme3 colonne">
				<img class="size500 resp_extend" src="images/FindTheBear/nightmare.jpg" alt="Nightmare">
				<p>
		...
		<section class="theme1 colonne">
			...
			<section class="theme3 colonne">
				<img class="size500 resp_extend" src="images/FindTheBear/vue_terrain_haute.jpg" alt="Top standpoint">
				<p>
			...
			<section class="theme2 colonne">
				<img class="size500 resp_extend" src="images/FindTheBear/perlin.jpg" alt="Perlin noise">
				<p>
